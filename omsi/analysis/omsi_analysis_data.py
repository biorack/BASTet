class omsi_analysis_data(dict) :
    ...
    """
    ana_hdf5link = -1  #Value used to indicate that a hard link to another dataset should be created when saving an analysis object
    
    import numpy as np 
    def __init__(self , name="undefined", data=np.empty( shape=(0) , dtype='float32' ) , dtype='float32') :
